        ...
        <div className="grid lg:grid-cols-3 md:gap-8">
            <div className="lg:col-span-2 rounded-lg">
              <div className="border bg-white">
                {groupedItems?.map(({product})=>{
                  ...
                  return (
                    <div key={product?._id} className="border-b p-2.5 last:border-b-0 flex items-center
                    justify-between gap-5"
                    >
                      <div className="flex flex-1 items-start gap-2 h-26 md:h-44">
                        {product?.images && <Link href={`/product/${product?.slug?.
                          current}`} className="border p-0.5 md:p-1 mr-2 rounded-md
                          ...
                          <div className="flex items-center gap-2">
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                className="relative top-0 rigt-0"/>
                                </TooltipTrigger>
                              ...
                              <Tooltip>
                                <TooltipTrigger>
                                  ...
                                  text-gray-400 hover:text-shop_dark_red hoverEffect"
                                  />
                                </TooltipTrigger>
                                <TooltipContent className="font-bold bg-shop_dark_red">
                                  Delete Product
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
            ...
            <div>
              <div className="lg:col-span-1">
                <div className="hidden md:inline-block w-full bg-white p-6 
                rounded-lg border">
                      ...
                      <CardContent>
                       ...
                       defaultValue={addresses?.find((addr)=> addr.default)?._id.toString()}>
                        {addresses?.map((address)=>(
                          ...
                          cursor-pointer ${selectedAddress?._id === address?._id
