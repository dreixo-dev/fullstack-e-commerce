...
const WishListProducts = () => {
  ...
  const handleResetWishlist = ()=>{
    const confirmReset = window.confirm("Are you sure you want to reset your wishlisht?");
    if (confirmReset) {
        resetFavorite();
                    ...
                    {favoriteProduct?.slice(0,visibleProducts)?.map((product:Product)=>(
                        <tr key={product?._id} className="border-b">
                            <td className="px-2 py-4 flex items-center gap-2">
                                ...
                                size={18} 
                                className="hover:text-shop_dark_red hover:cursor-pointer hoverEffect"
                                />
                                {product?.images && (
                   ...
                   bg-muted-foreground/20"/>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Items added to your wishlish will appear here
                        </p>
                    </div>
                <Button asChild>
